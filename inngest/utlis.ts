...
export function lastAssistanTextMessageContext(result:AgentResult){
    const lastAssistanTextMessageIndex=result.output.findLastIndex((message)=>message.role=="assistant",)
